        ...
        <>
            {
                loading ? (<Spinner />) : (<div className='px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2'>
                    <p className='text-center text-3xl font-bold text-gray'>Available crypto currency</p>
                    <p className='text-center mb-12 text-xl font-normal text-gray-500'>Total coin: 250</p>
